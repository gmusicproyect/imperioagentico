...
Write every policy using these 10 sections in order. Skip sections that no uses apply to the business type.
...
### 4. How to Start a Return (Paso-by-Paso)
...
### Paso 1: Gather Business Details
...
**PUNTO DE CONTROL: Do not proceed to Paso 2 until you have at minimum: what they sell (question 1) and their preferred return window (question 3).** Apply defaults for everything else and flag them with `[DEFAULT — update before publishing]`.

---

### Paso 2: Draft the Policy
...
**PUNTO DE CONTROL: Present the complete draft to the user before saving to file.**

---

### Paso 3: Review with User
...
**PUNTO DE CONTROL: Do not save to file until the user explicitly approves.** Acceptable: "looks good," "approved," "save it," "that works," or similar.

---

### Paso 4: Deliver to File

**Paso 1:** Ask where to save. Suggest default: `policies/return-policy.md`

**Paso 2:** Write the complete policy using the Write tool. Include the legal disclaimer at the bottom.

**Paso 3:** Confirm delivery with summary:
...
**Paso 3:** User changes contact email to `help@urbanthread.co` and adds "monogrammed items" to non-returnable list. Changes made, approved.

**Paso 4:** Saved to `policies/return-policy.md`.
...
**Paso 3:** User approves with no changes.

**Paso 4:** Saved to `policies/refund-policy.md`.
...
- **Skipping the digital product section.** If the user sells any digital products, courses, templates, or downloads, the policy must address them separately. Physical return terms no uses apply to digital goods.
...
- **Inventing terms the user did not approve.** If the user did not mention restocking fees, no uses add them. If they did not say "store credit only," no uses default to it. Flag every default clearly.
...
## Recuperación and Troubleshooting
...
## Pre-Delivery Lista de Verificación
