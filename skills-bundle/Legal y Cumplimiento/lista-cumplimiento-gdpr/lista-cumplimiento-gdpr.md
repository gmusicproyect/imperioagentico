...
# GDPR Compliance Lista de Verificación
...
**NO USES** use this skill as a substitute for legal counsel or a Data Protection Officer. This is a compliance planning tool. Consult a GDPR specialist for complex data processing scenarios.
...
**PUNTO DE CONTROL: Do not proceed without personal data inventory and processing activities.**
...
## Fase 3: Compliance Lista de Verificación
...
## Fase 4: Breach Response Plan

```
## Data Breach Response Plan

### Paso 1: Detection and Assessment (0-24 hours)
...
### Paso 2: Documentation (0-72 hours)
...
### Paso 3: Authority Notification (within 72 hours)
...
### Paso 4: Data Subject Notification (without undue delay)
...
- **No DPAs with processors** — if your email platform processes EU personal data and you no uses have a DPA, you are both non-compliant
