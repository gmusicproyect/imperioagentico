...
## Fase 1: Gather Contract Details
...
**PUNTO DE CONTROL: Do not proceed to Fase 2 until you have answers to at least questions 1-7.** Apply defaults for unanswered protection questions and flag them with `[DEFAULT — confirm with your attorney]`.

---

## Fase 2: Draft the Contract
...
**PUNTO DE CONTROL: Do not save to file until the user explicitly approves.** Acceptable: "looks good," "approved," "save it," "finalize," or similar.

---

## Fase 4: Deliver to File

**Paso 1:** Ask where to save. Suggest default: `contracts/[party-b-name]-[contract-type]-agreement.md`

**Paso 2:** Write the complete contract using the Write tool. Include the disclaimer at the top.
...
**Fase 2 drafts all 12 sections.** Key excerpt:
...
**Fase 3:** User adds "revision rounds beyond 2 cost $150 each." Change made, approved.

**Fase 4:** Saved to `contracts/greenleaf-bakery-freelance-service-agreement.md`.
...
**Fase 2 drafts with retainer-specific sections.** Key excerpt:
...
**Fase 3:** User adds "mid-month cancellation still owes the full month." Change made, approved.

**Fase 4:** Saved to `contracts/brightpath-labs-retainer-agreement.md`.
