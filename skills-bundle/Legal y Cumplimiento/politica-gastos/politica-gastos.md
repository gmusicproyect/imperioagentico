...
**NO USES** use this skill for budgeting (use budget-planner), accounting setup (use bookkeeping-setup), or personal expense tracking. This is for company expense policies.
...
**PUNTO DE CONTROL: Do not proceed without company size and common expense types.**

---

## Fase 2: Policy Framework
...
[Insert Fase 2 categories and limits]
[Insert Fase 3 rules and procedures]
