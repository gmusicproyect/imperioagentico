...
**NO USES** use this skill as a substitute for legal advice. This is a preparation and organization tool. Consult a trademark attorney for complex filings or legal questions.
...
**PUNTO DE CONTROL: Do not proceed without the mark and a description of goods/services.**

---

## Fase 2: Classification and Search
...
```
## Pre-Filing Search Lista de Verificación
...
## Fase 3: Application Preparation
...
### Specimen Lista de Verificación
...
### Application Lista de Verificación

```
## Filing Lista de Verificación
