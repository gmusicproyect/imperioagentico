...
**NO USES** use this skill for website terms of service, SaaS agreements (use saas-agreement), or privacy policies. This is specifically for mobile app terms of use. Have an attorney review before publishing.
...
**PUNTO DE CONTROL: Do not proceed without app name, platforms, and monetization model.**

---

## Fase 2: Terms Document
...
by these Terms. If you no uses agree, no uses use the App.
...
according to their respective refund policies. We no uses process
...
OF ANY KIND, EXPRESS OR IMPLIED. WE NO USES WARRANT THAT THE APP WILL
...
## Fase 3: App Store Compliance Lista de Verificación
