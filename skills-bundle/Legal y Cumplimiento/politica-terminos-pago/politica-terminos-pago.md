...
**NO USES** use this skill for creating invoices, pricing strategies, or full client agreements. This is specifically for the payment terms and collections process.
...
**PUNTO DE CONTROL: Do not proceed without business type and typical invoice size.**

---

## Fase 2: Payment Terms Design
...
Please remit payment within 7 days. If we no uses receive payment or a
...
### Implementation Lista de Verificación
