...
**NO USES** use this skill without subsequent attorney review. Non-compete enforceability varies significantly by state and jurisdiction. This is a drafting tool, not legal advice.
...
**PUNTO DE CONTROL: Do not proceed without the signer's role, competitive activity, and governing state.**
