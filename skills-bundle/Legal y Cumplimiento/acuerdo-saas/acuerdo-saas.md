...
**NO USES** use this skill for terms of service (general website), mobile app terms (use terms-of-use-app), or marketplace agreements. This is for SaaS-specific subscription agreements. Have an attorney review before use.
...
## Fase 1: Product and Service Details
...
**PUNTO DE CONTROL: Do not proceed without product name, pricing model, and data handling details.**

---

## Fase 2: Agreement Structure
...
```
## SaaS Agreement Lista de Verificación
...
- **Unrealistic SLA** — no uses promise 99.99% uptime if your infrastructure cannot deliver it. Set achievable targets.
