...
**NO USES** use this skill for full HR compliance manuals, employment contracts, or legal compliance in regulated industries. This is for practical workplace policies. Consult HR counsel for legal compliance requirements.
...
**PUNTO DE CONTROL: Do not proceed without company name, team size, and work arrangement.**

---

## Fase 2: Core Policies
...
- Time zone awareness — no uses schedule meetings outside someone's
...
- Respect focus time — no uses expect instant responses
```
...
- Remove sections that no uses apply to your business
...
```
## Policy Rollout Lista de Verificación
...
- **Copying big-company policies** — enterprise policies no uses fit startups. Write for your actual team size and culture.
...
- **Policies feel too corporate:** Rewrite in your brand voice. Policies no uses have to sound like legal documents — they should sound like your company.
