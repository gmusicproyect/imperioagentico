...
**NO USES** use this skill as a substitute for legal counsel. Data processing agreements have significant legal implications. Have an attorney review the final document.
...
**PUNTO DE CONTROL: Do not proceed without controller, processor, data types, and processing purpose.**
...
- Remove sections that no uses apply (e.g., international transfers if all processing is domestic)
